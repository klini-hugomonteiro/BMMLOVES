...
const faqs = [
  ...
  { q: "A página fica no ar para sempre?", a: "No plano Vitalício, sim! Sua página fica online para sempre, acessível de qualquer lugar. No plano de 24h, fica disponível por 1 dia." },
